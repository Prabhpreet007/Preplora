  ...
  return (
    <div className="flex flex-col w-full gap-8 py-5">
      ...
      <Headings
        ...
        description="Your personalized feedback is now available. Dive in to see detailed insights about your interview performance."
      />
            ...
            >
              ...
              <AccordionContent className="px-5 py-6 bg-white rounded-b-lg space-y-5 shadow-inner">
                ...
                <div className="text-lg font-semibold to-gray-700">
                  <Star className="mr-2 inline text-yellow-400" />
                  Rating: {feed.rating}
                </div>
